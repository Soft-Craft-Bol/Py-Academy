...
=======
import React, { useState } from "react";
import { ChevronDown, ChevronRight, Book, FileText, Video, Download, CheckCircle, Circle, User, Search, Bell, Menu, X, FolderOpen, Calendar, BookOpen, Users } from "lucide-react";
...
>>>>>>> f51f051ef489e8dc23180ed85a10d094266b8a38
];
      ...
      sections: [
        {
          ...
          completed: false,
          subsections: [
            { id: "2.1.1", title: "Arrow Functions y Destructuring", completed: false, type: "reading" },
        ...
        },
        {
          ...
          completed: false,
          subsections: [
            { id: "2.2.1", title: "Selección y modificación de elementos", completed: false, type: "reading" },
...
<<<<<<< HEAD
      ...
      due: '05/06/2025',
      description:
        'Aprenderás a declarar y usar variables en Python, con ejercicios guiados paso a paso.',
  ...
  noticias: [
    {
      ...
      date: '01/06/2025',
      content:
        'Ya puedes acceder al nuevo módulo de Introducción a la Inteligencia Artificial en la sección de materiales.',
      image: NuevoModulo,
    },
    {
      id: 2,
      ...
      date: '03/06/2025',
      content:
        'No te pierdas nuestro próximo webinar con expertos en frontend este viernes a las 6:00 PM.',
      image: Webinars,
    },
  ],
  avisos: [
...
=======
      ...
      due: "28/06/2025",
      description: "Crear una landing page responsive utilizando HTML5 semántico y CSS Grid/Flexbox.",
    ...
    },
    {
      ...
      due: "05/07/2025",
      description: "Desarrollar una calculadora interactiva usando JavaScript vanilla y programación orientada a objetos.",
    ...
    },
    {
      ...
      due: "15/07/2025",
      description: "Construir una aplicación de tareas usando React con hooks y gestión de estado local.",
      image: "https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=600&h=400&fit=crop",
      status: "upcoming"
>>>>>>> f51f051ef489e8dc23180ed85a10d094266b8a38
    },
...
function CourseDashboard() {
  ...
  const getTypeIcon = (type) => {
    switch (type) {
      ...
      case "slides": return <FileText className="w-4 h-4 text-purple-500" />;
      case "document": return <Book className="w-4 h-4 text-orange-500" />;
      case "code": return <FolderOpen className="w-4 h-4 text-blue-600" />;
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700">
        ...
        <div className="flex items-center space-x-3">
          ...
          <span className="text-lg font-bold text-gray-700 dark:text-gray-200">{courseData.progress}%</span>
        </div>
        <p className="text-sm text-gray-600 dark:text-gray-300 mt-2">¡Sigue así! Ya has completado el {courseData.progress}% del curso.</p>
      </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-3 mt-2">
                    ...
                    <span className="text-sm font-medium text-gray-600 dark:text-gray-300">{module.progress}%</span>
                  </div>
                </div>
              </div>
            </button>
                        ...
                        {section.subsections.map((subsection) => (
                          <button
                            ...
                            className={`w-full p-2 text-left hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center space-x-3 rounded-lg transition-colors ${
                              selectedItem === subsection.id ? 'bg-blue-100 dark:bg-blue-900/30 border-l-4 border-blue-500' : ''
                            }`}
                          >
...
<<<<<<< HEAD
            ...
            {activeTab === 'practicas' && (
              <>
                <h4 className="font-semibold text-xl text-gray-800 dark:text-white mb-1">
                  {item.title}
                </h4>
                <p className="text-sm text-gray-600 dark:text-gray-300 mb-2">
                  Fecha de entrega: {item.due}
                </p>
...
>>>>>>> f51f051ef489e8dc23180ed85a10d094266b8a38
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-xl text-gray-800 dark:text-white leading-tight">{item.title}</h4>
            ...
            {tabs.map((tab) => (
              <li key={tab.key}>
                ...
                >
                  ...
                  <span>{tab.label}</span>
=======
        <div className={`${sidebarCollapsed ? 'w-0' : 'w-80'} transition-all duration-300 bg-white dark:bg-gray-800 shadow-xl border-r border-gray-200 dark:border-gray-700 overflow-hidden`}>
          <div className="h-full flex flex-col">
            {/* Sidebar Header */}
...
<<<<<<< HEAD
        {/* Main Content */}
        <main className="flex-1 p-10 bg-gray-50 dark:bg-gray-900">{renderContent()}</main>
=======
            {/* Sidebar Content */}
              ...
              <div className="max-w-7xl mx-auto">
                ...
                {activeTab === "outline" ? (
                  <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                    <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-6">Contenido Interactivo</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                      <div className="text-center p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
                        ...
                        <h4 className="font-semibold text-gray-800 dark:text-white">Lecciones Interactivas</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-300 mt-2">Contenido multimedia y ejercicios prácticos</p>
                      </div>
                      <div className="text-center p-6 bg-green-50 dark:bg-green-900/20 rounded-xl">
                        <CheckCircle className="w-12 h-12 text-green-600 mx-auto mb-3" />
                        <h4 className="font-semibold text-gray-800 dark:text-white">Seguimiento de Progreso</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-300 mt-2">Monitorea tu avance en tiempo real</p>
                      </div>
                      <div className="text-center p-6 bg-purple-50 dark:bg-purple-900/20 rounded-xl">
                        <Users className="w-12 h-12 text-purple-600 mx-auto mb-3" />
                        <h4 className="font-semibold text-gray-800 dark:text-white">Comunidad</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-300 mt-2">Colabora con otros estudiantes</p>
                      </div>
                    </div>
                  </div>
                ) : (
