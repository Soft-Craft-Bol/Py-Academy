...
export function ProgressBar({ achievements = [] }) {
  if (!achievements.length) return null;
  return (
    <div className="w-full my-6 px-6 py-4 bg-white dark:bg-primary-pri4 rounded-2xl shadow-lg border border-blue-100 dark:border-primary-pri2">
