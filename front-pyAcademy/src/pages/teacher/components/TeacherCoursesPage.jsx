  ...
  return (
    <section className="px-4 md:px-10 py-10 min-h-screen">
      <div className="flex justify-between mb-5">
        ...
        <Button onClick={() => navigate('/teacher/create-course')}>Crear curso</Button>
      </div>
          ...
          >
            ...
            <div className="p-4 flex flex-col justify-between flex-grow">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400 flex flex-col gap-1 mt-2">
                ...
                <div className="flex items-center gap-2">
                  <FaUserGraduate />
                  <span>{/* {course.enrolled || 0} estudiantes */}</span>
                </div>
                <span>
                ...
                <span>
                  Fechas: {new Date(course.startDate).toLocaleDateString()} -{' '}
