package com.pyAcademy.pyAcademy.config;


import com.pyAcademy.pyAcademy.config.filter.JwtTokenValidator;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("https://www.inpasep.com", "http://localhost:5174"));
